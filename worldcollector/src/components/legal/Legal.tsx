...
import { APP_URL, LEGAL_COMPANY_NAME, LEGAL_DATE, LEGAL_LAST_UPDATED_DATE, SUPPORT_EMAIL, SUPPORT_FULL_NAME } from '~constants'
...
function Legal() {
  ...
  return (
    <div className="pt-2 pb-16 bg-neutral-50">
      <div className="px-4 md:px-8 container max-w-4xl">
        <Button
          onClick={() => navigate(-1)}
          variant="ghost"
        >
